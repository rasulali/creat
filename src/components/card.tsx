...
const Card = ({ link, name, text, icon }: CardProps) => {
  return <div className="w-full border col-span-1 md:rounded-2xl md:p-8 flex flex-col gap-y-6
    ...
    {icon}
    <Link href={link} className="md:text-2xl font-semibold hover:text-creatBright transition-colors duration-300">
      {name}
    </Link>
