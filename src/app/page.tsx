...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (data) {
        setPartnerProjects(
          data.reduce<Record<number, string>>((acc, project: Project) => {
            acc[project.id] = project.images[project.bannerImage];
            return acc;
          }, {}),
        );
      }
                ...
                <div className="flex flex-col gap-y-4">
                  ...
                  <TextAnim delay={0.1}>
                    <p className="text-xl max-w-[500px] leading-relaxed">
                      ...
                      clients, including government agencies, large
                      corporations, and international companies. Our commitment
                      to excellence and innovative solutions has allowed us to
                      deliver impactful projects across industries and borders
                    </p>
                  </TextAnim>
                </div>
            ...
            <div className="w-full mt-16">
              <TextAnim delay={0.2}>
                <p className="text-neutral-300 text-2xl">
                  ...
                  <br />
                  These services cover all stages from the beginning to the end
                  of the project
                </p>
              </TextAnim>
            </div>
            ...
            <div className="w-full mt-12 flex flex-col gap-y-4">
              <ParagraphAnimation>
                <p className="text-white text-2xl max-w-[800px]">
                  ...
                  extensive experience in modern construction and design fields,
                  implementing each project according to the specific needs of
                  our clients, driven by innovation and technological
                  advancements. Our goal is to meet our clients' needs at the
                  highest level in every project, ensuring their long-term
                  success
                </p>
              </ParagraphAnimation>
              <ParagraphAnimation>
