  ...
  return <section className="w-full relative font-jost overflow-hidden">
    <div className="relative">
      ...
      <div className="flex flex-col">
        ...
        <div className="h-[500px] w-full border-creatBG border-[64px] box-border">
    ...
    <div className="bg-creatBG">
      ...
      <div className="flex flex-col md:px-80 h-full w-full max-w-[1920px] mx-auto justify-center bg-creatBG">
        <div className="flex flex-col">
